...
export class DoctorService {
    ...
    async run(manifest, lockFile) {
        ...
        for (const source of manifest.sources) {
            ...
            const invalidLeafPaths = new Set(sourceLock?.invalidLeafs.map((leaf) => leaf.path) ?? []);
    ...
    async reportUnmanagedExternalSkills(lockFile, issues) {
