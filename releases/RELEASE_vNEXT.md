...
- Built-in deployment support now covers 32 Agent targets. The 10 icon-backed additions use isolated global and project path definitions, while the previous 22 targets retain their existing order and deployment behavior.
- Desktop target icons now include the supplied Agent assets, including dedicated Pi and OpenClaw icons.
