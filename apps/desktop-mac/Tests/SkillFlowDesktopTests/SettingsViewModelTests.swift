...
final class SettingsViewModelTests: XCTestCase {
    ...
    func testLoadsStoredValuesAndNormalizesSelections() {
        ...
        XCTAssertEqual(viewModel.detectedAgentRows(detectedTargetIds: ["codex", "claude-code", "zcode"]).map(\.targetId), ["codex", "claude-code", "zcode"])
    ...
    func testAgentDisplayCatalogReturnsMountPaths() {
        ...
        XCTAssertEqual(AgentDisplayCatalog.projectPath(for: "opencode"), ".opencode/skills")
        XCTAssertEqual(AgentDisplayCatalog.mountPath(for: "zcode"), "\(homePath)/.zcode/skills")
        XCTAssertEqual(AgentDisplayCatalog.projectPath(for: "zcode"), ".zcode/skills")
        XCTAssertEqual(AgentDisplayCatalog.mountPath(for: "trae"), "\(homePath)/.trae/skills")
        XCTAssertEqual(AgentDisplayCatalog.mountPath(for: "trae-cn"), "\(homePath)/.trae-cn/skills")
        XCTAssertEqual(AgentDisplayCatalog.projectPath(for: "trae-cn"), ".trae/skills")
